...
openRot = new Vector3 (defaultRot.x, defaultRot.y + 45, defaultRot.z);
//print(enter);
if(open){
//Open door
transform.eulerAngles = new Vector3.Slerp(transform.eulerAngles, openRot, Time.deltaTime * smooth);
print("defaultRot " + defaultRot);
print("openRot " + openRot);
print("transform.eulerAngles " + transform.eulerAngles);
}else{
//Close door
transform.eulerAngles = new Vector3.Slerp(transform.eulerAngles, defaultRot, Time.deltaTime * smooth);
}
