...
public class NewMouse : MonoBehaviour
{
	...
	public class NewMouseConfiguration
	{
	...
	public NewMouseConfiguration yaw = new NewMouseConfiguration { mouseButton = MouseButton.Right, sensitivity = 10F };
	
	// Pitch default configuration
	public NewMouseConfiguration pitch = new NewMouseConfiguration { mouseButton = MouseButton.Right, modifiers = new Modifiers{ leftControl = true }, sensitivity = 10F };
	
	// Roll default configuration
	public NewMouseConfiguration roll = new NewMouseConfiguration();
	
	// Vertical translation default configuration
	public NewMouseConfiguration verticalTranslation = new NewMouseConfiguration { mouseButton = MouseButton.Middle, sensitivity = 2F };
	
	// Horizontal translation default configuration
	public NewMouseConfiguration horizontalTranslation = new NewMouseConfiguration { mouseButton = MouseButton.Middle, sensitivity = 2F };
	
	// Depth (forward/backward) translation default configuration
	public NewMouseConfiguration depthTranslation = new NewMouseConfiguration { mouseButton = MouseButton.Left, sensitivity = 2F };
